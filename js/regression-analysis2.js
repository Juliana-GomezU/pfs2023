...
const kwhs = [165, 37, 26, 47, 61];
var l = linearRegression(months, kwhs);

//For Residents vs kWh
const residents = [2, 5, 3, 3, 3, 4, 4, 5, 3, 4];
const kWhs = [82, 180, 142, 164, 218, 220, 128, 260, 144, 120];
...
Plotly.newPlot("analysis2Plot1", data1, layout1);
Plotly.newPlot("analysis2Plot2", data2, layout2);
